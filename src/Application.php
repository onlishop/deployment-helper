...
namespace Onlishop\Deployment;

use Composer\InstalledVersions;
use Onlishop\Deployment\Helper\EnvironmentHelper;
use Onlishop\Deployment\Services\DotenvLoader;
...
class Application extends SymfonyApplication
{
    ...
    {
        parent::__construct('Onlishop Deployment Helper', InstalledVersions::getPrettyVersion('onlishop/deployment-helper') ?? 'development');
        ...
        $this->getDefinition()->addOption(new InputOption('project-config', null, InputOption::VALUE_REQUIRED, 'Path to .onlishop-project.yaml'));
    }
