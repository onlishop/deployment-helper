...
class OnlishopState
{
    ...
    {
        return InstalledVersions::isInstalled('onlishop/storefront');
    }
    ...
    {
        if (InstalledVersions::isInstalled('onlishop/platform')) {
            return (string) InstalledVersions::getVersion('onlishop/platform');
        }

        return (string) InstalledVersions::getVersion('onlishop/core');
    }
