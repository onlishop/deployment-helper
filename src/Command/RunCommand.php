...
namespace Onlishop\Deployment\Command;
...
#[AsCommand('run', description: 'Install or Update Onlishop')]
class RunCommand extends Command
{
    public function __construct(
        private readonly OnlishopState $state,
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $config = new RunConfiguration(
            ...
            timeout: (float) (is_numeric($timeout) ? $timeout : EnvironmentHelper::getVariable('ONLISHOP_DEPLOYMENT_TIMEOUT', '300')),
            forceReinstallation: EnvironmentHelper::getVariable('ONLISHOP_DEPLOYMENT_FORCE_REINSTALL', '0') === '1',
        );
