...
class FastlyServiceUpdaterTest extends TestCase
{
    ...
    public function testCreateSnippet(): void
    {
        ...
        $fastlyAPIClient
            ...
            ->with('SERVICE_ID', 0, 'onlishop_deliver', 'deliver', 'TEST');
    ...
    public function testCreateSnippetWithPriority(): void
    {
        ...
        $fastlyAPIClient
            ->expects($this->once())
            ->method('createSnippet')
            ->with('SERVICE_ID', 0, 'onlishop_deliver_test', 'deliver', 'TEST', 5);
    ...
    public function testUpdateSnippet(): void
    {
        ...
        $fastlyAPIClient
            ...
            ->with('SERVICE_ID', 1)
            ->willReturn([
                ['name' => 'onlishop_deliver', 'priority' => 0, 'content' => 'OLD'],
            ]);
    ...
    public function testContentNotChangedDoesNothing(): void
    {
        ...
        $fastlyAPIClient
            ...
            ->with('SERVICE_ID', 1)
            ->willReturn([
                ['name' => 'onlishop_deliver', 'priority' => 0, 'content' => 'TEST'],
            ]);
