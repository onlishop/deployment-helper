...
class ConfigFactoryTest extends TestCase
{
    ...
    #[Env('ONLISHOP_STORE_LICENSE_DOMAIN', 'test')]
    ...
    public function testCreateWithProjectConfigOption(): void
    {
        ...
        $customConfigPath = __DIR__ . '/_fixtures/yml/.onlishop-project.yml';
    ...
    public function testCreateWithProjectConfigOptionRelativePath(): void
    {
        ...
        $config = ConfigFactory::create(__DIR__ . '/_fixtures', $this->createMockApplication('yml/.onlishop-project.yml'));

        static::assertTrue($config->extensionManagement->enabled);
        static::assertSame(['foo' => 'test'], $config->oneTimeTasks);
    }

    #[Env('ONLISHOP_PROJECT_CONFIG_FILE', '_fixtures/yml/.onlishop-project.yml')]
