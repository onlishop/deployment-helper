...
class OnlishopStateTest extends TestCase
{
    ...
    private OnlishopState $state;

    protected function setUp(): void
    {
        $this->connection = $this->createMock(Connection::class);
        $this->state = new OnlishopState($this->connection);
    }

    public function testOnlishopIsNotInstalled(): void
    {
    ...
    public function testOnlishopIsInstalled(): void
    {
        $this->connection
            ->expects($this->once())
